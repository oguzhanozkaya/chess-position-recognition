...
export FIP_EPOCHS := env("FIP_EPOCHS", "2400")
export FIP_PATIENCE := env("FIP_PATIENCE", "6000")
export FIP_BATCH_SIZE := env("FIP_BATCH_SIZE", "1024")
export FIP_LEARNING_RATE := env("FIP_LEARNING_RATE", "0.0005")
...
export FIP_MAX_VOCAB_SIZE := env("FIP_MAX_VOCAB_SIZE", "3000")
...
export FIP_FUSION_HIDDEN_SIZE := env("FIP_FUSION_HIDDEN_SIZE", "256")
export FIP_GRU_HIDDEN_SIZE := env("FIP_GRU_HIDDEN_SIZE", "256")
